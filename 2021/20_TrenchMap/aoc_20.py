...
#                           a o c _ 2 0 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 20"
...
def parse_command_line():
    ...
    desc = 'Trench Map - Day 20 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = image.Image(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = image.Image(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 4873
    else:
        result = part_two(args, input_text)  # 16394
