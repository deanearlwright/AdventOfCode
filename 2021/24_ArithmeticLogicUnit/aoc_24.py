...
#                           a o c _ 2 4 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 24"
...
def parse_command_line():
    ...
    desc = 'Arithmetic Logic Unit - Day 24 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = monad.Monad(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = monad.Monad(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 12996997829399
    else:
        result = part_two(args, input_text)  # 11841231117189
