...
#                           a o c _ 0 6 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 06"
...
def parse_command_line():
    ...
    desc = 'Lanternfish - Day 06 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = fishes.Fishes(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = fishes.Fishes(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 366057
    else:
        result = part_two(args, input_text)  # 1653559299811
