...
#                           a o c _ 2 5 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 25"
...
def parse_command_line():
    ...
    desc = 'Sea Cucumber - Day 25 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = seafloor.Seafloor(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = seafloor.Seafloor(part2=True, text=input_lines)
