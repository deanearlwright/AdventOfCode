...
#                           a o c _ 0 7 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 07"
...
def parse_command_line():
    ...
    desc = 'The Treachery of Whales - Day 07 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = crabs.Crabs(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = crabs.Crabs(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 347011
    else:
        result = part_two(args, input_text)  # 98363777
