...
#                           a o c _ 0 3 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 03"
...
def parse_command_line():
    ...
    desc = 'Binary Diagnostic - Day 03 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = diagnostic.Diagnostic(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 4103154
    else:
        result = part_two(args, input_text)  # 4245351
