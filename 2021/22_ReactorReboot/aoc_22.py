...
#                           a o c _ 2 2 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 22"
...
def parse_command_line():
    ...
    desc = 'Reactor Reboot - Day 22 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = cubes.Cubes(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 589411
    else:
        result = part_two(args, input_text)  # 1130514303649907
