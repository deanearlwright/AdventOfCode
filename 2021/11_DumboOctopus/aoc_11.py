...
#                           a o c _ 1 1 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 11"
...
def parse_command_line():
    ...
    desc = 'Dumbo Octopus - Day 11 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = flashers.Flashers(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = flashers.Flashers(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 1681
    else:
        result = part_two(args, input_text)  # 276
