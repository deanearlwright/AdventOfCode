...
#                           a o c _ 0 2 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 02"
...
def parse_command_line():
    ...
    desc = 'Dive - Day 02 of Advent of Code 2021'
    sample = 'sample: python aoc_02.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = dive.Dive(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = dive.Dive(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 2091984
    else:
        result = part_two(args, input_text)  # 2086261056
