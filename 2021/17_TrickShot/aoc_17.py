...
#                           a o c _ 1 7 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 17"
...
def parse_command_line():
    ...
    desc = 'Trick Shot - Day 17 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = probe.Probe(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 4186
    else:
        result = part_two(args, input_text)  # 2709
