...
#                           a o c _ 0 5 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 05"
...
def parse_command_line():
    ...
    desc = 'Hydrothermal Venture - Day 05 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = vents.Vents(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = vents.Vents(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 7269
    else:
        result = part_two(args, input_text)  # 21140
