...
#                           a o c _ 2 1 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 21"
...
def parse_command_line():
    ...
    desc = 'Dirac Dice - Day 21 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = game.Game(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = game.Game(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 1073709
    else:
        result = part_two(args, input_text)  # 148747830493442
