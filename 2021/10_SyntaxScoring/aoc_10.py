...
#                           a o c _ 1 0 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 10"
...
def parse_command_line():
    ...
    desc = 'Syntax Scoring - Day 10 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = navigation.Navigation(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = navigation.Navigation(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 216297
    else:
        result = part_two(args, input_text)  # 2165057169
