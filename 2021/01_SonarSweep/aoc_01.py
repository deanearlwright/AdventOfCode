...
#                           a o c _ 0 1 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 01"
...
def parse_command_line():
    ...
    desc = 'Sonar Sweep - Day 01 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = sonar.Sonar(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 1448
    else:
        result = part_two(args, input_text)  # 1471
