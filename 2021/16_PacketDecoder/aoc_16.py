...
#                           a o c _ 1 6 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 16"
...
def parse_command_line():
    ...
    desc = 'Packet Decoder - Day 16 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = packets.Packets(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 875
    else:
        result = part_two(args, input_text)  # 1264857437203
