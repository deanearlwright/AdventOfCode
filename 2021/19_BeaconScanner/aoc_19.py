...
#                           a o c _ 1 9 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 19"
...
def parse_command_line():
    ...
    desc = 'Beacon Scanner - Day 19 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = scanners.Scanners(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 381
    else:
        result = part_two(args, input_text)  # 12201
