...
#                           a o c _ 0 9 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 09"
...
def parse_command_line():
    ...
    desc = 'Smoke Basin - Day 09 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = caves.Caves(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 456
    else:
        result = part_two(args, input_text)  # 1047744
