...
#                           a o c _ 1 5 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 15"
...
def parse_command_line():
    ...
    desc = 'Chiton - Day 15 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = risk.Risk(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 487
    else:
        result = part_two(args, input_text)  # 2821
