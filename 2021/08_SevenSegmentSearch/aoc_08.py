...
#                           a o c _ 0 8 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2021 day 08"
...
def parse_command_line():
    ...
    desc = 'Seven Segment Search - Day 08 of Advent of Code 2021'
...
def part_one(args, input_lines):
    ...
    solver = patterns.Patterns(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 274
    else:
        result = part_two(args, input_text)  # 1012089
