...
# ======================================================================
"Test solver for Advent of Code 2022 day 03, Rucksack Reorganization"
...
class TestSolver(unittest.TestCase):  # pylint: disable=R0904
    ...
    def test_empty_init(self):
        ...
        self.assertEqual(len(myobj.rucksacks), 0)
    ...
    def test_text_init(self):
        ...
        self.assertEqual(len(myobj.rucksacks), 6)

        # 3. Check methods
        self.assertEqual(myobj.total_prioirity(), 157)
        self.assertEqual(myobj.get_badge_letters(), "rZ")

    def test_part_one(self):
        "Test part one example of Solver object"

        # 1. Create Solver object from text
        myobj = solver.Solver(text=aoc_03.from_text(PART_ONE_TEXT))
    ...
    def test_part_two(self):
        ...
        # 1. Create Solver object from text
        myobj = solver.Solver(part2=True, text=aoc_03.from_text(PART_TWO_TEXT))
