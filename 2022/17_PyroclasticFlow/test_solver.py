...
# ======================================================================
"Test solver for Advent of Code 2022 day 17, Pyroclastic Flow"
...
PART_ONE_RESULT = 3068
PART_TWO_RESULT = 1514285714288
...
class TestSolver(unittest.TestCase):  # pylint: disable=R0904
    ...
    def test_empty_init(self):
        ...
        self.assertEqual(myobj.simulation, None)
    ...
    def test_text_init(self):
        ...
        self.assertNotEqual(myobj.simulation, None)

    def test_part_one(self):
        "Test part one example of Solver object"

        # 1. Create Solver object from text
        myobj = solver.Solver(text=aoc_17.from_text(PART_ONE_TEXT))
