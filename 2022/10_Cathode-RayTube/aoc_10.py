...
#                           a o c _ 1 0 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2022 day 10"
...
def parse_command_line():
    ...
    desc = 'Cathode-Ray Tube - Day 10 of Advent of Code 2022'
    ...
    parser.add_argument('-l', '--limit', action='store',
                        default=0, type=int,
                        dest='limit',
                        help='Maximum (time, size, loops) before stopping')
...
def part_two(args, input_lines):
    ...
    if solution is None:
        ...
        print(f"The solution for part two is \n{solution}")
...
def from_file(filepath, keep_blank=False):
    ...
    return from_text(open(filepath, encoding="utf-8").read(), keep_blank)
