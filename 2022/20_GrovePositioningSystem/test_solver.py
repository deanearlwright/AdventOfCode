...
# ======================================================================
"Test solver for Advent of Code 2022 day 20, Grove Positioning System"
...
class TestSolver(unittest.TestCase):  # pylint: disable=R0904
    ...
    def test_text_init(self):
        ...
        myobj = solver.Solver(text=aoc_20.from_text(EXAMPLE_TEXT))
    ...
    def test_part_one(self):
        ...
        # 1. Create Solver object from text
        myobj = solver.Solver(text=aoc_20.from_text(PART_ONE_TEXT))
