...
#                           a o c _ 2 0 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2022 day 20"
...
def parse_command_line():
    ...
    desc = 'Grove Positioning System - Day 20 of Advent of Code 2022'
...
def part_one(args, input_lines):  # pylint disable=E1128
    ...
    solution = my_solver.part_one(verbose=args.verbose,
                                  limit=args.limit)
    if solution is None:
...
def part_two(args, input_lines):  # pylint disable=E1128
    ...
    solution = my_solver.part_two(verbose=args.verbose,
                                  limit=args.limit)
    if solution is None:
        print("There is no solution")
    else:
