...
# ======================================================================
"Test solver for Advent of Code 2022 day 16, Proboscidea Volcanium"
...
PART_ONE_RESULT = 1651
PART_TWO_RESULT = 1707
...
class TestSolver(unittest.TestCase):  # pylint: disable=R0904
    ...
    def test_text_init(self):
        ...
        myobj = solver.Solver(text=aoc_16.from_text(EXAMPLE_TEXT))
    ...
    def test_part_one(self):
        ...
        # 1. Create Solver object from text
        myobj = solver.Solver(text=aoc_16.from_text(PART_ONE_TEXT))
