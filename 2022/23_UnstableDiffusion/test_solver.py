...
# ======================================================================
"Test solver for Advent of Code 2022 day 23, Unstable Diffusion"
...
class TestSolver(unittest.TestCase):  # pylint: disable=R0904
    ...
    def test_text_init(self):
        ...
        myobj = solver.Solver(text=aoc_23.from_text(EXAMPLE_TEXT))

        # 2. Make sure it has the expected values
        self.assertEqual(myobj.part2, False)
        self.assertEqual(len(myobj.text), 12)
        self.assertNotEqual(myobj.process, None)
