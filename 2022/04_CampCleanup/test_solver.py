...
# ======================================================================
"Test solver for Advent of Code 2022 day 04, Camp Cleanup"
...
class TestSolver(unittest.TestCase):  # pylint: disable=R0904
    ...
    def test_empty_init(self):
        ...
        self.assertEqual(len(myobj.pairs), 0)
    ...
    def test_text_init(self):
        ...
        self.assertEqual(len(myobj.pairs), 6)

    def test_part_one(self):
        "Test part one example of Solver object"

        # 1. Create Solver object from text
        myobj = solver.Solver(text=aoc_04.from_text(PART_ONE_TEXT))
    ...
    def test_part_two(self):
        ...
        # 1. Create Solver object from text
        myobj = solver.Solver(part2=True, text=aoc_04.from_text(PART_TWO_TEXT))
