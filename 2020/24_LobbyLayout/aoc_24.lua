...
--                           a o c _ 2 4 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 24
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_24"
    :description "Lobby Layout - Day 24 of Advent of Code 2020"
    :epilog "sample: lua aoc_24.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = tiles:Tiles({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = tiles:Tiles({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 263
  else
    result = part_two(args, input_text) -- 3649
  end
