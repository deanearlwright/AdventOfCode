...
--                           a o c _ 2 2 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 22
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_22"
    :description "Crab Combat - Day 22 of Advent of Code 2020"
    :epilog "sample: lua aoc_22.lua input.txt"
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 31629
  else
    result = part_two(args, input_text) -- 35196
  end
