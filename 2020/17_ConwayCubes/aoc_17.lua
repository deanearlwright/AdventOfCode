...
--                           a o c _ 1 7 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 17
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_17"
    :description "Conway Cubes - Day 17 of Advent of Code 2020"
    :epilog "sample: lua aoc_17.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = pocket:Pocket({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = pocket:Pocket({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 213
  else
    result = part_two(args, input_text) -- 1624
  end
