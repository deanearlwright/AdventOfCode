...
def parse_command_line():
    ...
    desc = 'Allergen Assessment - Day 21 of Advent of Code 2020'
    ...
    parser.add_argument('-l', '--limit', action='store', default=DEFAULT_LIMIT, type=int,
                        dest='limit',
...
def part_one(args, input_lines):
    ...
    solver = shopping.Shopping(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = shopping.Shopping(part2=True, text=input_lines)
