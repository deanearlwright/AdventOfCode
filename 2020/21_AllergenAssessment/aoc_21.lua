...
--                           a o c _ 2 1 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 21
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_21"
    :description "Allergen Assessment - Day 21 of Advent of Code 2020"
    :epilog "sample: lua aoc_21.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = shopping:Shopping({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = shopping:Shopping({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 2302
  else
    result = part_two(args, input_text) -- smfz,vhkj,qzlmr,tvdvzd,lcb,lrqqqsg,dfzqlk,shp
  end
