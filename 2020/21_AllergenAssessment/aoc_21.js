...
//                             a o c _ 2 1 . t s
//
// Solve the Advent of Code 2020 day 21 problem
// ======================================================================
// ----------------------------------------------------------------------
//                                                                 import
// ----------------------------------------------------------------------
...
function parseCommandLine() {
    ...
    var argv = yargs
        .command('aoc_21', 'Allergen Assessment - Day 21 of Advent of Code 2020', {})
        .option('verbose', {
        alias: 'v',
        "default": false,
...
function partOne(args, inputLines) {
    ...
    var solver = new shopping_1.Shopping(inputLines, false);
...
function partTwo(args, inputLines) {
    ...
    // 1. Create the puzzle solver
    var solver = new shopping_1.Shopping(inputLines, true);
...
function main() {
    ...
    if (argv.part === 1) {
        result = partOne(argv, inputText); // 2302
    }
    else {
        result = partTwo(argv, inputText); // smfz,vhkj,qzlmr,tvdvzd,lcb,lrqqqsg,dfzqlk,shp
    }
