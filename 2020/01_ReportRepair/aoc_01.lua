...
--                           a o c _ 0 1 . l u a
-- ======================================================================
-- "Solve the puzzles for Advent of Code 2020 day 01"
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_01"
    :description "Report Repair - Day 01 of Advent of Code 2020"
...
function part_one(args, input_lines)
  ...
  local solver = report:Report({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = report:Report({part2=true, text=input_lines})
