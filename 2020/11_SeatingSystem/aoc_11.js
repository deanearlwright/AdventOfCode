...
//                             a o c _ 1 1 . t s
//
// Solve the Advent of Code 2020 day 11 problem
// ======================================================================
// ----------------------------------------------------------------------
//                                                                 import
// ----------------------------------------------------------------------
...
function parseCommandLine() {
    ...
    var argv = yargs
        .command('aoc_11', 'Seating System - Day 11 of Advent of Code 2020', {})
        .option('verbose', {
        alias: 'v',
        "default": false,
...
function partOne(args, inputLines) {
    ...
    var solver = new conway_1.Conway(inputLines, false);
...
function partTwo(args, inputLines) {
    ...
    // 1. Create the puzzle solver
    var solver = new conway_1.Conway(inputLines, true);
