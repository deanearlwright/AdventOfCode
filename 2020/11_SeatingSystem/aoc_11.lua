...
--                           a o c _ 1 1 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 11
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_11"
    :description "Seating System - Day 11 of Advent of Code 2020"
    :epilog "sample: lua aoc_11.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = conway:Conway({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = conway:Conway({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 2359
  else
    result = part_two(args, input_text) -- 2131
  end
