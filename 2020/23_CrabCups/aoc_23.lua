...
--                           a o c _ 2 3 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 23
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_23"
    :description "Crab Cups - Day 23 of Advent of Code 2020"
    :epilog "sample: lua aoc_23.lua input.txt"
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 29385746
  else
    result = part_two(args, input_text) -- 680435423892
  end
