...
--                           a o c _ 1 2 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 12
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_12"
    :description "Rain Risk - Day 12 of Advent of Code 2020"
    :epilog "sample: lua aoc_12.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = navigation:Navigation({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = navigation:Navigation({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 1496
  else
    result = part_two(args, input_text) -- 63843
  end
