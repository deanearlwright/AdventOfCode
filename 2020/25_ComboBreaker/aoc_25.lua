...
--                           a o c _ 2 5 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 25
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_25"
    :description "Combo Breaker - Day 25 of Advent of Code 2020"
    :epilog "sample: lua aoc_25.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = handshake:Handshake({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = handshake:Handshake({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 9620012
  else
    result = part_two(args, input_text) -- There is no real part2 
  end
