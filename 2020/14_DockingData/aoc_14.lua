...
--                           a o c _ 1 4 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 14
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_14"
    :description "Docking Data - Day 14 of Advent of Code 2020"
    :epilog "sample: lua aoc_14.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = bitmask:Bitmask({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = bitmask:Bitmask({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 17934269678453
  else
    result = part_two(args, input_text) -- 3440662844064
  end
