...
--                           a o c _ 0 7 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 07
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_07"
    :description "Handy Haversacks - Day 07 of Advent of Code 2020"
...
function part_one(args, input_lines)
  ...
  local solver = rules:Rules({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = rules:Rules({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 335
  else
    result = part_two(args, input_text) -- 2431
  end
