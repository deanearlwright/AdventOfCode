...
def parse_command_line():
    ...
    desc = 'Handheld Halting - Day 08 of Advent of Code 2020'
...
def part_one(args, input_lines):
    ...
    solver = console.Console(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = console.Console(part2=True, text=input_lines)
