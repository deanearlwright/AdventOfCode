...
--                           a o c _ 0 8 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 08
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_08"
    :description "Handheld Halting - Day 08 of Advent of Code 2020"
...
function part_one(args, input_lines)
  ...
  local solver = console:Console({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = console:Console({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 1744
  else
    result = part_two(args, input_text) -- 1174
  end
