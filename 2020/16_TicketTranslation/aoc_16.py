...
def parse_command_line():
    ...
    desc = 'Ticket Translation - Day 16 of Advent of Code 2020'
...
def part_one(args, input_lines):
    ...
    solver = tickets.Tickets(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = tickets.Tickets(part2=True, text=input_lines)
...
def from_text(text):
    ...
    for line in text.strip().splitlines():
        ...
        # 3. But ignore comments and blank lines
        if not line:
            continue
        if line.startswith('!'):
            continue
