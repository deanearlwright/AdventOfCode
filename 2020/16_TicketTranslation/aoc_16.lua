...
--                           a o c _ 1 6 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 16
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_16"
    :description "Ticket Translation - Day 16 of Advent of Code 2020"
    :epilog "sample: lua aoc_16.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = tickets:Tickets({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = tickets:Tickets({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 26869
  else
    result = part_two(args, input_text) -- 855275529001
  end
