...
#                           a o c _ 0 6 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2020 day 06"
...
def parse_command_line():
    ...
    desc = 'Custom Customs - Day 06 of Advent of Code 2020'
    sample = 'sample: python aoc_06.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = groups.Groups(part2=False, text=input_lines)
...
def from_text(text):
    ...
    # 1. We start with no lines and no collected answers
    lines = []
    collected = []
    ...
    for line in text.split('\n'):
        ...
        # 4. Output collected answers at a blank line
        line = line.rstrip(' \r')
        if not line:
            if len(collected) > 0:
    ...
    # 6. Add any remaining collection of answers
    if len(collected) > 0:
        lines.append(' '.join(collected))

    # 7. Return a list of clean answer lines
    return lines
