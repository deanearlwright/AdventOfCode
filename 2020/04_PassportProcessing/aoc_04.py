...
#                           a o c _ 0 4 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2020 day 04"
...
def parse_command_line():
    ...
    desc = 'Passport Processing - Day 04 of Advent of Code 2020'
...
def part_one(args, input_lines):
    ...
    solver = scanner.Scanner(part2=False, text=input_lines)
...
def from_text(text):
    ...
    # 1. We start with no lines and no collected passport fields
    lines = []
    collected = []
    ...
    for line in text.split('\n'):
        ...
        # 4. Output collected passport fields at a blank line
        line = line.rstrip(' \r')
        if not line:
            if len(collected) > 0:
        ...
        # 5. Add the line to the collection
        collected.append(line)

    # 6. Add any remaining collection of passport fields
    if len(collected) > 0:
        lines.append(' '.join(collected))

    # 7. Return a list of clean passport lines
    return lines
