...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_04"
    :description "Passport Processing - Day 04 of Advent of Code 2020"
...
function part_one(args, input_lines)
  ...
  local solver = passports:Passports({part2=false, text=input_lines})
  ...
  if solution == nil then
     ...
     print("The solution for part one is " .. solution) -- 237
  end
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = passports:Passports({part2=true, text=input_lines})
    ...
    if solution == nil then
        ...
        print("The solution for part two is " .. solution) -- 172
    end
