...
--                           a o c _ 1 0 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 10
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_10"
    :description "Adapter Array - Day 10 of Advent of Code 2020"
...
function part_one(args, input_lines)
  ...
  local solver = jolts:Jolts({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = jolts:Jolts({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 1917
  else
    result = part_two(args, input_text) -- 113387824750592
  end
