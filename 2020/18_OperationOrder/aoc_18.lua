...
--                           a o c _ 1 8 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 18
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_18"
    :description "Operation Order - Day 18 of Advent of Code 2020"
    :epilog "sample: lua aoc_18.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = homework:Homework({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = homework:Homework({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 650217205854
  else
    result = part_two(args, input_text) -- 20394514442037
  end
