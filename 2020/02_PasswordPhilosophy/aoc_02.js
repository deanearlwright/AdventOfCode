...
//                             a o c _ 0 2 . t s
//
// Solve the Advent of Code 2020 day 02 problem
// ======================================================================
// ----------------------------------------------------------------------
//                                                                 import
// ----------------------------------------------------------------------
...
function parseCommandLine() {
    ...
    var argv = yargs
        .command('aoc_02', 'Password Philosophy - Day 02 of Advent of Code 2020', {})
        .option('verbose', {
        alias: 'v',
        "default": false,
...
function partOne(args, inputLines) {
    ...
    var solver = new passwords_1.Passwords(inputLines, false);
...
function partTwo(args, inputLines) {
    ...
    // 1. Create the puzzle solver
    var solver = new passwords_1.Passwords(inputLines, true);
...
function fromText(text) {
    ...
    text.split(/\r?\n/).forEach(function (line) {
        ...
        var cleaned = line.replace(/[\x09\x0a\x0b\x0c\x0d\x20\xa0]+$/, '');
