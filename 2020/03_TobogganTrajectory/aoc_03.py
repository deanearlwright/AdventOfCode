...
def parse_command_line():
    ...
    desc = 'Toboggan Trajectory - Day 03 of Advent of Code 2020'
...
def part_one(args, input_lines):
    ...
    solver = toboggan.Toboggan(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = toboggan.Toboggan(part2=True, text=input_lines)
