...
//                             a o c _ 0 3 . t s
//
// Solve the Advent of Code 2020 day 03 problem
// ======================================================================
// ----------------------------------------------------------------------
//                                                                 import
// ----------------------------------------------------------------------
...
function parseCommandLine() {
    ...
    var argv = yargs
        .command('aoc_03', 'Toboggan Trajectory - Day 03 of Advent of Code 2020', {})
        .option('verbose', {
        alias: 'v',
        "default": false,
...
function partOne(args, inputLines) {
    ...
    var solver = new trees_1.Trees(inputLines, false);
...
function partTwo(args, inputLines) {
    ...
    // 1. Create the puzzle solver
    var solver = new trees_1.Trees(inputLines, true);
