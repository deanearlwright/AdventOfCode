...
--                           a o c _ 0 3 . l u a
-- ======================================================================
-- "Solve the puzzles for Advent of Code 2020 day 03"
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_03"
    :description "Toboggan Trajectory - Day 03 of Advent of Code 2020"
...
function part_one(args, input_lines)
  ...
  local solver = trees:Trees({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = trees:Trees({part2=true, text=input_lines})
