...
//                             a o c _ 0 9 . t s
//
// Solve the Advent of Code 2020 day 09 problem
// ======================================================================
// ----------------------------------------------------------------------
//                                                                 import
// ----------------------------------------------------------------------
...
function parseCommandLine() {
    ...
    var argv = yargs
        .command('aoc_09', 'Encoding Error - Day 09 of Advent of Code 2020', {})
        .option('verbose', {
        alias: 'v',
        "default": false,
...
function partOne(args, inputLines) {
    ...
    var solver = new cypher_1.Cypher(inputLines, false);
...
function partTwo(args, inputLines) {
    ...
    // 1. Create the puzzle solver
    var solver = new cypher_1.Cypher(inputLines, true);
