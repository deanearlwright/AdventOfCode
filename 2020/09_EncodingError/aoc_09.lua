...
--                           a o c _ 0 9 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 09
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_09"
    :description "Encoding Error - Day 09 of Advent of Code 2020"
    :epilog "sample: lua aoc_09.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = cypher:Cypher({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = cypher:Cypher({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text)  -- 1492208709
  else
    result = part_two(args, input_text)  -- 238243506
  end
