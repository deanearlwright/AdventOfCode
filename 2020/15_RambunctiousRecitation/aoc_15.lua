...
--                           a o c _ 1 5 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 15
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_15"
    :description "Rambunctious Recitation - Day 15 of Advent of Code 2020"
    :epilog "sample: lua aoc_15.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = game:Game({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = game:Game({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 232
  else
    result = part_two(args, input_text) -- 18929178
  end
