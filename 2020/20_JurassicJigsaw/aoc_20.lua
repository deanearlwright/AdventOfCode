...
--                           a o c _ 2 0 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 20
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_20"
    :description "Jurassic Jigsaw - Day 20 of Advent of Code 2020"
    :epilog "sample: lua aoc_20.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = image:Image({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = image:Image({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 14986175499719
  else
    result = part_two(args, input_text) -- 2161
  end
