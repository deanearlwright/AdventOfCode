...
--                           a o c _ 1 3 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 13
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_13"
    :description "Shuttle Search - Day 13 of Advent of Code 2020"
    :epilog "sample: lua aoc_13.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = buses:Buses({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = buses:Buses({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 4938
  else
    result = part_two(args, input_text) -- 230903629977901
  end
