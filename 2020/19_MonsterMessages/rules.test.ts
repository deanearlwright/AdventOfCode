...
//
// Test the solver for Advent of Code 2020 day 19 problem
// ======================================================================
...
describe('Rules', () => {
  test('Test the default Rules creation', () => {
    ...
    expect(myobj.messages).toHaveLength(0);
  });
  ...
  test('Test the Rules object creation from text', () => {
    ...
    expect(myobj.messages).toHaveLength(5);
    expect(myobj.rules[2].definition).toBe('4 4 | 5 5');
    expect(myobj.messages[1]).toBe('bababa');

    // 3. Check methods
    expect(myobj.countZero()).toBe(2);
  });
