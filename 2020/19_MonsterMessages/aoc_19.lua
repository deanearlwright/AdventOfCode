...
--                           a o c _ 1 9 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2020 day 19
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_19"
    :description "Monster Messages - Day 19 of Advent of Code 2020"
    :epilog "sample: lua aoc_19.lua input.txt"
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text)  -- 124
  else
    result = part_two(args, input_text)  -- 228
  end
