...
#                           a o c _ 0 6 . p y
# ======================================================================
"Solve the Memory Reallocation problem for Advent of Code 2017 day 06"
...
def parse_command_line():
    ...
    desc = 'Memory Reallocation - Day 06 of Advent of Code 2017'
...
def part_one(args, input_lines):
    ...
    solver = memory.Memory(part2=False,
                           text=input_lines[0])
    ...
    if solution is None:
        ...
        print("A previous configuration was seen in %d redistribution cycles" % (solution))
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = memory.Memory(part2=True,
                           text=input_lines[0])
