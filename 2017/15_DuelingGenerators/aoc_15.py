...
#                           a o c _ 1 5 . p y
# ======================================================================
"Solve the Dueling Generators problem for Advent of Code 2017 day 15"
...
def parse_command_line():
    ...
    desc = 'Dueling Generators - Day 15 of Advent of Code 2017'
    sample = 'sample: python aoc_15.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = generator.Generators(part2=False, text=input_lines)
    ...
    if solution is None:
        ...
        print("After 40 million pairs, the judge's final count is %d" % (solution))
...
def part_two(args, input_lines):
    ...
    if solution is None:
        ...
        print("After 5 million pairs, the judge's final count is %d" % (solution))
