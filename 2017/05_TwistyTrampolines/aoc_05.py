# ======================================================================
# HA Maze of Twisty Trampolines, All Alike
...
#                           a o c _ 0 5 . p y
# ======================================================================
"Solve the Twisty Trampolines problem for Advent of Code 2017 day 05"
...
def parse_command_line():
    ...
    desc = 'Twisty Trampolines - Day 05 of Advent of Code 2017'
    sample = 'sample: python aoc_05.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = jumps.Jumps(part2=False,
                         text=input_lines)

    # 2. Generate the number of steps until escaped
    solution = solver.goto_the_exit(verbose=args.verbose)
    if solution is None:
        print("The CPU can not reach the exit")
    else:
        print("The CPU will reach the exit in %d jumps" % (solution))
...
def main():
    """Read the Twisty Trampolines problem and solve it"""
