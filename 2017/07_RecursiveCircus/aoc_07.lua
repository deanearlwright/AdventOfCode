...
--                           a o c _ 0 7 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2017 day 07
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_07"
    :description "Recursive Circus - Day 07 of Advent of Code 2017"
    :epilog "sample: lua aoc_07.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = tower:Tower({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = tower:Tower({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- eqgvf
  else
    result = part_two(args, input_text) -- 757
  end
