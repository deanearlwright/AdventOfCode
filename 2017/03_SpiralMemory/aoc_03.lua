...
--                           a o c _ 0 3 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2017 day 03
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_03"
    :description "SpiralMemory - Day 03 of Advent of Code 2017"
    :epilog "sample: lua aoc_03.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = spiral:Spiral({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = spiral:Spiral({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 438
  else
    result = part_two(args, input_text) -- 266330
  end
