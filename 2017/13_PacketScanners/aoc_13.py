...
#                           a o c _ 1 3 . p y
# ======================================================================
"Solve the Digital Plumber problem for Advent of Code 2017 day 13"
...
def parse_command_line():
    ...
    desc = 'Packet Scanners - Day 13 of Advent of Code 2017'
    sample = 'sample: python aoc_13.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = firewall.Firewall(part2=False, text=input_lines)

    # 2. Determine the severity of the packet trip
    solution = solver.trip(verbose=args.verbose, limit=args.limit)
    if solution is None:
        print("There is no solution")
    else:
        print("The severity of the whole trip leaving immeiately is %d" % (solution))
...
def part_two(args, input_lines):
    ...
    # 2. Determine the severity of the packet trip
    solution = solver.part_two_mod(verbose=args.verbose, limit=args.limit)
    if solution is None:
        print("There is no solution")
    else:
        print("The shortest delay that will let the packet not get caught is is %d" % (solution))
