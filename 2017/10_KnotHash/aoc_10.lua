...
--                           a o c _ 1 0 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2017 day 10
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_10"
    :description "KnotHash - Day 10 of Advent of Code 2017"
    :epilog "sample: lua aoc_10.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = hash:Hash({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = hash:Hash({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 1935
  else
    result = part_two(args, input_text) -- dc7e7dee710d4c7201ce42713e6b8359
  end
