...
#                           a o c _ 1 4 . p y
# ======================================================================
"Solve the Disk Defragmenter problem for Advent of Code 2017 day 13"
...
def parse_command_line():
    ...
    desc = 'Disk Defragmenter - Day 14 of Advent of Code 2017'
    sample = 'sample: python aoc_14.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = defrag.Defrag(part2=False, text=input_lines[0])
    ...
    if solution is None:
        ...
        print("The number of squares used is %d" % (solution))
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = defrag.Defrag(part2=True, text=input_lines[0])
    ...
    if solution is None:
        ...
        print("The number of regions is %d" % (solution))
