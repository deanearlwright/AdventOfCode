...
#                           a o c _ 1 7 . p y
# ======================================================================
"Solve the Spinlock problem for Advent of Code 2017 day 17"
...
def parse_command_line():
    ...
    desc = 'Spinlock - Day 17 of Advent of Code 2017'
...
def part_one(args, input_lines):
    ...
    solver = spinlock.Spinlock(part2=False, text=input_lines[0])
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = spinlock.Spinlock(part2=True, text=input_lines[0])
