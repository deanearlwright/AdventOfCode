# ======================================================================
#  Inverse Captcha
#   Advent of Code 2017 Day010 -- Eric Wastl -- https://adventofcode.com
#
...
#                           a o c _ 0 1 . p y
# ======================================================================
"Solve the Inverse Captcha problem for Advent of Code 2017 day 01"
...
def parse_command_line():
    ...
    desc = 'Inverse Captcha - day 01 of Advent of Code 2017'
    sample = 'sample: python aoc_01.py input.txt'
...
def part_one(args, input_lines):
    ...
    if solution is None:
        print("You could not solve the captcha")
    else:
        print("The solution to the captcha is %d" % (solution))
...
def main():
    """Read the Inverse Captcha problem and solve it"""
