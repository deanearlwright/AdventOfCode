...
--                           a o c _ 0 1 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2017 day 01
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_01"
    :description "InverseCaptcha - Day 01 of Advent of Code 2017"
    :epilog "sample: lua aoc_01.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = catcha:Catcha({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = catcha:Catcha({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 1228
  else
    result = part_two(args, input_text) -- 1238
  end
