...
#                           a o c _ 0 4 . p y
# ======================================================================
"Solve the High-Entropy Passphrases problem for Advent of Code 2017 day 03"
...
def parse_command_line():
    ...
    desc = 'High-Entropy Passphrases - Day 04 of Advent of Code 2017'
    sample = 'sample: python aoc_04.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = passphrases.PassPhrases(part2=False,
                                     text=input_lines)

    # 2. Generate the number of valid passphrases
    solution = solver.knt_valid(verbose=args.verbose)
    if solution is None:
        print("You could not determine the valid passphrases")
    else:
        print("The number of valid passphrases is %d" % (solution))
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = passphrases.PassPhrases(part2=True,
                                     text=input_lines)
