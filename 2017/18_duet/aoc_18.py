...
#                           a o c _ 1 8 . p y
# ======================================================================
"Solve the recover problem for Advent of Code 2017 day 18"
...
def parse_command_line():
    ...
    desc = 'duet - Day 18 of Advent of Code 2017'
...
def part_one(args, input_lines):
    ...
    solver = recover.Recover(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = recover.Recover(part2=True, text=input_lines)
