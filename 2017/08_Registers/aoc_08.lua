...
--                           a o c _ 0 8 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2017 day 08
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_08"
    :description "Registers - Day 08 of Advent of Code 2017"
    :epilog "sample: lua aoc_08.lua input.txt"
...
function part_one(args, input_lines)
  ...
  local solver = registers:Registers({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = registers:Registers({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 5752
  else
    result = part_two(args, input_text) -- 6366
  end
