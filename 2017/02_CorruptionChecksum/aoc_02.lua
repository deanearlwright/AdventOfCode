...
--                           a o c _ 0 2 . l u a
-- ======================================================================
-- Solve the puzzles for Advent of Code 2017 day 02
...
function parse_command_line ()
  ...
  local parser = argparse()
    :name "aoc_02"
    :description "Corruption Checksum - Day 02 of Advent of Code 2017"
...
function part_one(args, input_lines)
  ...
  local solver = checksum:Checksum({part2=false, text=input_lines})
...
function part_two(args, input_lines)
    ...
    -- 1. Create the puzzle solver
    local solver = checksum:Checksum({part2=true, text=input_lines})
...
function main()
  ...
  local result = nil
  if args.part == 1 then
    result = part_one(args, input_text) -- 45972
  else
    result = part_two(args, input_text) -- 326
  end
