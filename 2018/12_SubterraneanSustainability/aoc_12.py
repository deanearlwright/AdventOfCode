...
#                           a o c _ 1 2 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2018 day 12"
...
def parse_command_line():
    ...
    desc = 'Subterranean Sustainability - Day 12 of Advent of Code 2018'
...
def part_one(args, input_lines):
    ...
    solver = pots.Pots(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = pots.Pots(part2=True, text=input_lines)
