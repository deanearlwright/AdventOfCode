...
#                           a o c _ 1 7 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2018 day 17"
...
def parse_command_line():
    ...
    desc = 'Reservoir Research - Day 17 of Advent of Code 2018'
...
def part_one(args, input_lines):
    ...
    solver = scans.Scans(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = scans.Scans(part2=True, text=input_lines)
