...
#                           a o c _ 2 1 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2018 day 21"
...
def parse_command_line():
    ...
    desc = 'Chronal Conversion - Day 21 of Advent of Code 2018'
...
def part_one(args, input_lines):
    ...
    solver = bitwise.Bitwise(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = bitwise.Bitwise(part2=True, text=input_lines)
