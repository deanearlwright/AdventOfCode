...
#                           a o c _ 1 6 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2018 day 16"
...
def parse_command_line():
    ...
    desc = 'Chronal Classification - Day 16 of Advent of Code 2018'
...
def part_one(args, input_lines):
    ...
    solver = device.Device(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = device.Device(part2=True, text=input_lines)
...
def from_text(text):
    ...
    for line in text.split('\n'):
        ...
        # 3. Ignore comment lines
        if line.startswith('!'):
            continue

        # 4. Ignore blank lines but only at the beginning
    ...
    # 6. Return a list of cleaned lines
    return lines
