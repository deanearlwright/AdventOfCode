...
#                           a o c _ 0 8 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2018 day 08"
...
def parse_command_line():
    ...
    desc = 'Memory Maneuver - Day 08 of Advent of Code 2018'
...
def part_one(args, input_lines):
    ...
    solver = license.License(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = license.License(part2=True, text=input_lines)
