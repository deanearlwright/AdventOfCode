...
#                           a o c _ 2 4 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2018 day 24"
...
def parse_command_line():
    ...
    desc = 'Immune System Simulator 20XX - Day 24 of Advent of Code 2018'
...
def part_one(args, input_lines):
    ...
    solver = reindeer.Reindeer(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = reindeer.Reindeer(part2=True, text=input_lines)
