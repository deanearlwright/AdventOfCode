...
#                           a o c _ 1 1 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2018 day 11"
...
def parse_command_line():
    ...
    desc = 'Chronal Charge - Day 11 of Advent of Code 2018'
...
def part_one(args, input_lines):
    ...
    solver = fuelcell.Fuelcell(part2=False, text=input_lines)
    ...
    if solution is None:
        ...
        print("The solution for part one is (%d,%d)" % (solution))
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = fuelcell.Fuelcell(part2=True, text=input_lines)
    ...
    if solution is None:
        ...
        print("The solution for part two is (%d,%d,%d)" % (solution))
