...
#                           a o c _ 1 8 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2018 day 18"
...
def parse_command_line():
    ...
    desc = 'Settlers of The North Pole - Day 18 of Advent of Code 2018'
...
def part_one(args, input_lines):
    ...
    solver = acres.Acres(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = acres.Acres(part2=True, text=input_lines)
