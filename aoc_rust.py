...
#                           a o c _ r s . p y
# ======================================================================
"Generates rust base programming source files for Advent of Code"
...
-- ======================================================================
-- end                  M O D U L E _ t e s t . r s                   end
-- ======================================================================
"""
...
-- ======================================================================
-- end                  E X T R A _ t e s t. r s                end
-- ======================================================================
"""

RUST_FILES = {
    'aoc_DD.rust': AOC_DD_RUST,
    'MODULE.rust': MODULE_RUST,
    'MODULE_test.rust': MODULE_TEST_RUST,
    'part_one.txt': PART_ONE_TXT,
    'part_two.txt': PART_TWO_TXT,
}

RUST_EXTRA = {
    'EXTRA.rust': EXTRA_RUST,
    'EXTRA_test.rust': EXTRA_TEST_RUST,
}

RUST_UPDATE = {}


def rust_before(args):
...
def rust_after(args, converters, text):
    "Cleanup text"
