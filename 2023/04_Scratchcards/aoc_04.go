...
//                           a o c _ 0 4 . g o
// ======================================================================
// Solve the puzzles for Advent of Code 2023 day 04
...
func partOne(verbose bool, limit int, input_lines []string) string {
	...
	solver, err := NewCards(false, input_lines)
	if err != nil {
		fmt.Printf("unable to construct solver %s", err)
		return ""
	}
...
func partTwo(verbose bool, limit int, input_lines []string) string {
	...
	// 1. Create the puzzle solver
	solver, err := NewCards(true, input_lines)
	if err != nil {
		fmt.Printf("unable to construct solver %s", err)
		return ""
	}
