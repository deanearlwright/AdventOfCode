...
#                         s o l v e r . p y
# ======================================================================
"A solver for the Advent of Code 2023 Day 24 puzzle"
...
class Solver(object):   # pylint: disable=R0902, R0205
    ...
    def __init__(self, text=None, part2=False):
        ...
        if text is not None and len(text) > 0:
            self.hailstones = Hailstones(text=text, part2=part2)
    ...
    def part_one(self, verbose=False, limit=0):
        ...
        if self.text:
            return self.hailstones.xyintersections()
        return None
    ...
    def part_two(self, verbose=False, limit=0):
        ...
        if self.text:
            return self.hailstones.xyzintersections()
        return None
