...
//                           a o c _ 0 2 . g o
// ======================================================================
// Solve the puzzles for Advent of Code 2023 day 02
...
func partOne(verbose bool, limit int, input_lines []string) string {
	...
	solver, err := NewSolver(false, input_lines)
	if err != nil {
		fmt.Printf("Unable to process input %s", err)
	}
...
func partTwo(verbose bool, limit int, input_lines []string) string {
	...
	// 1. Create the puzzle solver
	solver, err := NewSolver(true, input_lines)
	if err != nil {
		fmt.Printf("Unable to process input %s", err)
	}
