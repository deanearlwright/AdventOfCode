...
#                           a o c _ 1 3 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2023 day 13"
...
def parse_command_line():
    ...
    desc = 'Point of Incidence - Day 13 of Advent of Code 2023'
...
def from_file(filepath, keep_blank=True):
    "Read the file"
...
def from_text(text, keep_blank=True):
...
def main():
    ...
    input_text = from_file(args.filepath, keep_blank=True)
