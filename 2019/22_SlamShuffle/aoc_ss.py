...
#                           a o c _ s s . p y
# ======================================================================
"Solve the Slam Shuffle problem for Advent of Code 2019 day 22"
...
def parse_command_line():
    ...
    desc = 'Slam Shuffle - day 22 of Advent of Code 2019'
...
def part_one(args, input_lines):
    ...
    # 1. Create the space card deck
    cards = deck.Deck()

    # 2. Execute the instructions
    cards.instructions(text=input_lines, verbose=args.verbose, watch=args.maxtime)
...
def main():
    """Read the Slam Shuffle problem and solve it"""
