...
#                           a o c _ 2 5 . p y
# ======================================================================
"Solve the Cryostasis problem for Advent of Code 2019 day 25"
...
def parse_command_line():
    ...
    desc = 'Cryostasis - day 25 of Advent of Code 2019'
...
def part_one(args, input_lines):
    ...
    # 1. Create the droid
    luey = adv_droid.Droid(text=input_lines[0])

    # 2. Do it
    halted = luey.interactive(watch=args.verbose)
    if halted != intcode.STOP_INP:
        print("The droid, luey, stopped unexpectly, reason = %d" % (halted))
        solution = None
    else:
        solution = 42
        print("The password is %d" % (solution))
...
def main():
    """Read the Cryostasis problem and solve it"""
