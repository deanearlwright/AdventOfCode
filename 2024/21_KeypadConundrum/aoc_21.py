...
#                           a o c _ 2 1 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2024 day 21"
...
def parse_command_line():
    ...
    desc = 'Keypad Conundrum - Day 21 of Advent of Code 2024'
...
def part_one(args, input_lines):  # pylint: disable=E1128
    ...
    my_solver = keypad.Keypad(part2=False, text=input_lines)
...
def part_two(args, input_lines):  # pylint: disable=E1128
    ...
    # 1. Create the puzzle solver
    my_solver = keypad.Keypad(part2=True, text=input_lines)
