...
#                           a o c _ 1 4 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2024 day 14"
...
def parse_command_line():
    ...
    desc = 'Restroom Redoubt - Day 14 of Advent of Code 2024'
...
def part_one(args, input_lines):  # pylint: disable=E1128
    ...
    my_solver = lobby.Lobby(part2=False, text=input_lines)
...
def part_two(args, input_lines):  # pylint: disable=E1128
    ...
    # 1. Create the puzzle solver
    my_solver = lobby.Lobby(part2=True, text=input_lines)
