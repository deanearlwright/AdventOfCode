...
#                           a o c _ 0 4 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2024 day 04"
...
def parse_command_line():
    ...
    desc = 'Ceres Search - Day 04 of Advent of Code 2024'
...
def part_one(args, input_lines):  # pylint: disable=E1128
    ...
    my_solver = words.Words(part2=False, text=input_lines)
...
def part_two(args, input_lines):  # pylint: disable=E1128
    ...
    # 1. Create the puzzle solver
    my_solver = words.Words(part2=True, text=input_lines)
