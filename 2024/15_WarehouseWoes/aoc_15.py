...
#                           a o c _ 1 5 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2024 day 15"
...
def parse_command_line():
    ...
    desc = 'Warehouse Woes - Day 15 of Advent of Code 2024'
...
def part_one(args, input_lines):  # pylint: disable=E1128
    ...
    my_solver = warehouse.Warehouse(part2=False, text=input_lines)
...
def part_two(args, input_lines):  # pylint: disable=E1128
    ...
    # 1. Create the puzzle solver
    my_solver = warehouse.Warehouse(part2=True, text=input_lines)
