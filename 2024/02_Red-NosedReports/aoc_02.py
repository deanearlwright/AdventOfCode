...
#                           a o c _ 0 2 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2024 day 02"
...
def parse_command_line():
    ...
    desc = 'Red-Nosed Reports - Day 02 of Advent of Code 2024'
...
def part_one(args, input_lines):  # pylint: disable=E1128
    ...
    my_solver = reports.Reports(part2=False, text=input_lines)
...
def part_two(args, input_lines):  # pylint: disable=E1128
    ...
    # 1. Create the puzzle solver
    my_solver = reports.Reports(part2=True, text=input_lines)
