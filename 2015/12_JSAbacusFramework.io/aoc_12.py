...
#                           a o c _ 1 2 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 12"
...
def parse_command_line():
    ...
    desc = 'JSAbacusFramework.io - Day 12 of Advent of Code 2015'
...
def part_one(args, input_lines):
    ...
    solver = abacus.Abacus(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 191164
    else:
        result = part_two(args, input_text)  # 87842
