...
#                           a o c _ 0 8 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 08"
...
def parse_command_line():
    ...
    desc = 'Matchsticks - Day 08 of Advent of Code 2015'
...
def part_one(args, input_lines):
    ...
    solver = literals.Literals(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = literals.Literals(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 1333
    else:
        result = part_two(args, input_text)  # 2046
