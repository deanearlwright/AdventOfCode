...
#                           a o c _ 0 7 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 07"
...
def parse_command_line():
    ...
    desc = 'Some Assembly Required - Day 07 of Advent of Code 2015'
...
def part_one(args, input_lines):
    ...
    solver = gates.Gates(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 46065
    else:
        result = part_two(args, input_text)  # 14134
