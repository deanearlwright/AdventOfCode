...
#                           a o c _ 1 4 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 14"
...
def parse_command_line():
    ...
    desc = 'Reindeer Olympics - Day 14 of Advent of Code 2015'
...
def part_one(args, input_lines):
    ...
    solver = olympics.Olympics(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 2696
    else:
        result = part_two(args, input_text)  # 1084
