...
#                           a o c _ 0 9 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 09"
...
def parse_command_line():
    ...
    desc = 'All in a Single Night - Day 09 of Advent of Code 2015'
...
def part_one(args, input_lines):
    ...
    solver = routes.Routes(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = routes.Routes(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 251
    else:
        result = part_two(args, input_text)  # 898
