...
#                           a o c _ 2 0 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 20"
...
def parse_command_line():
    ...
    desc = 'Infinite Elves and Infinite Houses - Day 20 of Advent of Code 2015'
    sample = 'sample: python aoc_20.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = fedelf.Fedelf(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = fedelf.Fedelf(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 831600
    else:
        result = part_two(args, input_text)  # 884520
