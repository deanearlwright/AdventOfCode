...
//                             a o c _ 2 0 . j s
//
// Solve the Advent of Code 2015 day 20 problem
// ======================================================================
...
function parseCommandLine() {
  ...
  const { argv } = yargs
    .command('aoc_20', 'Infinite Elves and Infinite Houses - Day 20 of Advent of Code 2015', { })
    .option('verbose', {
      alias: 'v',
      default: false,
...
function partOne(args, inputLines) {
  ...
  const solver = new fedelf.Fedelf({ part2: false, text: inputLines });
...
function partTwo(args, inputLines) {
  ...
  // 1. Create the puzzle solver
  const solver = new fedelf.Fedelf({ part2: true, text: inputLines });
