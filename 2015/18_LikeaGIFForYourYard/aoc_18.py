...
#                           a o c _ 1 8 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 18"
...
def parse_command_line():
    ...
    desc = 'Like a GIF For Your Yard - Day 18 of Advent of Code 2015'
...
def part_one(args, input_lines):
    ...
    solver = conway.Conway(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 1061
    else:
        result = part_two(args, input_text)  # 1006
