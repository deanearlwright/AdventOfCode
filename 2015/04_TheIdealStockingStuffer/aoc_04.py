...
#                           a o c _ 0 4 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 04"
...
def parse_command_line():
    ...
    desc = 'The Ideal Stocking Stuffer - Day 04 of Advent of Code 2015'
...
def part_one(args, input_lines):
    ...
    solver = miner.Miner(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 254575
    else:
        result = part_two(args, input_text)  # 1038736
