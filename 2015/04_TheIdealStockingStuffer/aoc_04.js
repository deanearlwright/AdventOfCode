...
//                             a o c _ 0 4 . j s
//
// Solve the Advent of Code 2015 day 04 problem
// ======================================================================
...
function parseCommandLine() {
  ...
  const { argv } = yargs
    .command('aoc_04', 'The Ideal Stocking Stuffer - Day 04 of Advent of Code 2015', { })
    .option('verbose', {
      alias: 'v',
      default: false,
...
function partOne(args, inputLines) {
  ...
  const solver = new miner.Miner({ part2: false, text: inputLines });
...
function partTwo(args, inputLines) {
  ...
  // 1. Create the puzzle solver
  const solver = new miner.Miner({ part2: true, text: inputLines });
