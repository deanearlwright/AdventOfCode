...
#                           a o c _ 0 3 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 03"
...
def parse_command_line():
    ...
    desc = 'Perfectly Spherical Houses in a Vacuum - Day 03 of Advent of Code 2015'
...
def part_one(args, input_lines):
    ...
    solver = vacuum.Vacuum(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = vacuum.Vacuum(part2=True, text=input_lines)
