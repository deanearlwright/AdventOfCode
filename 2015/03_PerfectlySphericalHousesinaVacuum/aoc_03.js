...
//                             a o c _ 0 3 . j s
//
// Solve the Advent of Code 2015 day 03 problem
// ======================================================================
...
function parseCommandLine() {
  ...
  const { argv } = yargs
    .command('aoc_03', 'Perfectly Spherical Houses in a Vacuum - Day 03 of Advent of Code 2015', { })
    .option('verbose', {
      alias: 'v',
      default: false,
...
function partOne(args, inputLines) {
  ...
  const solver = new santa.Santa({ part2: false, text: inputLines });
...
function partTwo(args, inputLines) {
  ...
  // 1. Create the puzzle solver
  const solver = new santa.Santa({ part2: true, text: inputLines });
