...
#                           a o c _ 1 9 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 19"
...
def parse_command_line():
    ...
    desc = 'Medicine for Rudolph - Day 19 of Advent of Code 2015'
    sample = 'sample: python aoc_19.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = medicine.Medicine(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = medicine.Medicine(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 518
    else:
        result = part_two(args, input_text)  # 200
