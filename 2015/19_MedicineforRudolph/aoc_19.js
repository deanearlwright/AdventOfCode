...
//                             a o c _ 1 9 . j s
//
// Solve the Advent of Code 2015 day 19 problem
// ======================================================================
...
function parseCommandLine() {
  ...
  const { argv } = yargs
    .command('aoc_19', 'Medicine for Rudolph - Day 19 of Advent of Code 2015', { })
    .option('verbose', {
      alias: 'v',
      default: false,
...
function partOne(args, inputLines) {
  ...
  const solver = new chemistry.Chemistry({ part2: false, text: inputLines });
...
function partTwo(args, inputLines) {
  ...
  // 1. Create the puzzle solver
  const solver = new chemistry.Chemistry({ part2: true, text: inputLines });
