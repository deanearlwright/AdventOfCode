...
#                           a o c _ 1 1 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 11"
...
def parse_command_line():
    ...
    desc = 'Corporate Policy - Day 11 of Advent of Code 2015'
...
def part_one(args, input_lines):
    ...
    solver = password.Password(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = password.Password(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # hxbxxyzz
    else:
        result = part_two(args, input_text)  # hxcaabcc
