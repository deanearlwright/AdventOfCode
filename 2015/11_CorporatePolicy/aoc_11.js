...
//                             a o c _ 1 1 . j s
//
// Solve the Advent of Code 2015 day 11 problem
// ======================================================================
...
function parseCommandLine() {
  ...
  const { argv } = yargs
    .command('aoc_11', 'Corporate Policy - Day 11 of Advent of Code 2015', { })
    .option('verbose', {
      alias: 'v',
      default: false,
...
function partOne(args, inputLines) {
  ...
  const solver = new password.Password({ part2: false, text: inputLines });
...
function partTwo(args, inputLines) {
  ...
  // 1. Create the puzzle solver
  const solver = new password.Password({ part2: true, text: inputLines });
