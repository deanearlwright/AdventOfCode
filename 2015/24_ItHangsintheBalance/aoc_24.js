...
//                             a o c _ 2 4 . j s
//
// Solve the Advent of Code 2015 day 24 problem
// ======================================================================
...
function parseCommandLine() {
  ...
  const { argv } = yargs
    .command('aoc_24', 'It Hangs in the Balance - Day 24 of Advent of Code 2015', { })
    .option('verbose', {
      alias: 'v',
      default: false,
...
function partOne(args, inputLines) {
  ...
  const solver = new packages.Packages({ part2: false, text: inputLines });
...
function partTwo(args, inputLines) {
  ...
  // 1. Create the puzzle solver
  const solver = new packages.Packages({ part2: true, text: inputLines });
