...
#                           a o c _ 1 0 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 10"
...
def parse_command_line():
    ...
    desc = 'Elves Look Elves Say - Day 10 of Advent of Code 2015'
...
def part_one(args, input_lines):
    ...
    solver = lookandsay.Lookandsay(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = lookandsay.Lookandsay(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 329356
    else:
        result = part_two(args, input_text)  # 4666278
