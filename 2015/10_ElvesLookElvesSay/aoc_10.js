...
//                             a o c _ 1 0 . j s
//
// Solve the Advent of Code 2015 day 10 problem
// ======================================================================
...
function parseCommandLine() {
  ...
  const { argv } = yargs
    .command('aoc_10', 'Elves Look Elves Say - Day 10 of Advent of Code 2015', { })
    .option('verbose', {
      alias: 'v',
      default: false,
...
function partOne(args, inputLines) {
  ...
  const solver = new lookandsay.Lookandsay({ part2: false, text: inputLines });
...
function partTwo(args, inputLines) {
  ...
  // 1. Create the puzzle solver
  const solver = new lookandsay.Lookandsay({ part2: true, text: inputLines });
