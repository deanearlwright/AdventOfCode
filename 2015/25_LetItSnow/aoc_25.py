...
#                           a o c _ 2 5 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 25"
...
def parse_command_line():
    ...
    desc = 'Let It Snow - Day 25 of Advent of Code 2015'
...
def part_one(args, input_lines):
    ...
    solver = codes.Codes(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = codes.Codes(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 19980801
    else:
