...
#                           a o c _ 2 3 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 23"
...
def parse_command_line():
    ...
    desc = 'Opening the Turing Lock - Day 23 of Advent of Code 2015'
...
def part_one(args, input_lines):
    ...
    solver = computer.Computer(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = computer.Computer(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 184
    else:
