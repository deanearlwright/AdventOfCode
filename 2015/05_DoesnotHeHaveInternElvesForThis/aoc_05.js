...
//                             a o c _ 0 5 . j s
//
// Solve the Advent of Code 2015 day 05 problem
// ======================================================================
...
function parseCommandLine() {
  ...
  const { argv } = yargs
    .command('aoc_05', 'Does not He Have Intern Elves For This - Day 05 of Advent of Code 2015', { })
    .option('verbose', {
      alias: 'v',
      default: false,
...
function partOne(args, inputLines) {
  ...
  const solver = new naughty.Naughty({ part2: false, text: inputLines });
...
function partTwo(args, inputLines) {
  ...
  // 1. Create the puzzle solver
  const solver = new naughty.Naughty({ part2: true, text: inputLines });
