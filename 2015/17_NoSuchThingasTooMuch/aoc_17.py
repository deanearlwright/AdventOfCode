...
#                           a o c _ 1 7 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 17"
...
def parse_command_line():
    ...
    desc = 'No Such Thing as Too Much - Day 17 of Advent of Code 2015'
    sample = 'sample: python aoc_17.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = eggnog.Eggnog(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = eggnog.Eggnog(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 1638
    else:
        result = part_two(args, input_text)  # 17
