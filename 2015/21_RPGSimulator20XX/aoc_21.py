...
#                           a o c _ 2 1 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 21"
...
def parse_command_line():
    ...
    desc = 'RPG Simulator 20XX - Day 21 of Advent of Code 2015'
...
def part_one(args, input_lines):
    ...
    solver = rpgsim.Rpgsim(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = rpgsim.Rpgsim(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 91
    else:
        result = part_two(args, input_text)  # 158
