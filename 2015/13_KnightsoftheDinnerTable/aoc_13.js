...
//                             a o c _ 1 3 . j s
//
// Solve the Advent of Code 2015 day 13 problem
// ======================================================================
...
function parseCommandLine() {
  ...
  const { argv } = yargs
    .command('aoc_13', 'Knights of the Dinner Table - Day 13 of Advent of Code 2015', { })
    .option('verbose', {
      alias: 'v',
      default: false,
...
function partOne(args, inputLines) {
  ...
  const solver = new seating.Seating({ part2: false, text: inputLines });
...
function partTwo(args, inputLines) {
  ...
  // 1. Create the puzzle solver
  const solver = new seating.Seating({ part2: true, text: inputLines });
