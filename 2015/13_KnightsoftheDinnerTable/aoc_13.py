...
#                           a o c _ 1 3 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2015 day 13"
...
def parse_command_line():
    ...
    desc = 'Knights of the Dinner Table - Day 13 of Advent of Code 2015'
...
def part_one(args, input_lines):
    ...
    solver = seating.Seating(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = seating.Seating(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 733
    else:
        result = part_two(args, input_text)  # 725
