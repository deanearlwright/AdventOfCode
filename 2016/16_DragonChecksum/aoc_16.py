...
#                           a o c _ 1 6 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 16"
...
def parse_command_line():
    ...
    desc = 'Dragon Checksum - Day 16 of Advent of Code 2016'
...
def part_one(args, input_lines):
    ...
    solver = dragon.Dragon(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 00100111000101111
    else:
        result = part_two(args, input_text)  # 11101110011100110
