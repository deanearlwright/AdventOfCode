...
#                           a o c _ 2 4 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 24"
...
def parse_command_line():
    ...
    desc = 'Air Duct Spelunking - Day 24 of Advent of Code 2016'
...
def part_one(args, input_lines):
    ...
    solver = robot.Robot(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = robot.Robot(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 460
    else:
        result = part_two(args, input_text)  # 668
