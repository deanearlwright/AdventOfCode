...
#                           a o c _ 1 9 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 19"
...
def parse_command_line():
    ...
    desc = 'An Elephant Named Joseph - Day 19 of Advent of Code 2016'
...
def part_one(args, input_lines):
    ...
    solver = elves.Elves(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 1841611
    else:
        result = part_two(args, input_text)  # 1423634
