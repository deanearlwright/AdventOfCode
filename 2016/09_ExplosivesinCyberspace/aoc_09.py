...
#                           a o c _ 0 9 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 09"
...
def parse_command_line():
    ...
    desc = 'Explosives in Cyberspace - Day 09 of Advent of Code 2016'
    sample = 'sample: python aoc_09.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = decompress.Decompress(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = decompress.Decompress(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 74532
    else:
        result = part_two(args, input_text)  # 11558231665
