...
//                             a o c _ 0 4 . t s
//
// Solve the Advent of Code 2016 day 04 problem
// ======================================================================
...
function parseCommandLine(): aocArguments {
  ...
  const { argv } = yargs
    .command('aoc_04', 'Security Through Obscurity - Day 04 of Advent of Code 2016', { })
    .option('verbose', {
      alias: 'v',
      default: false,
...
function partOne(args: aocArguments, inputLines: string[]): boolean {
  ...
  const solver = new Encrypted(inputLines, false);
...
function partTwo(args: aocArguments, inputLines: string[]): boolean {
  ...
  // 1. Create the puzzle solver
  const solver = new Encrypted(inputLines, true);
