...
#                           a o c _ 0 4 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 04"
...
def parse_command_line():
    ...
    desc = 'Security Through Obscurity - Day 04 of Advent of Code 2016'
...
def part_one(args, input_lines):
    ...
    solver = list.List(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = list.List(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 278221
    else:
        result = part_two(args, input_text)  # 267
