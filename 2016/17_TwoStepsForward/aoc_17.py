...
#                           a o c _ 1 7 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 17"
...
def parse_command_line():
    ...
    desc = 'Two Steps Forward - Day 17 of Advent of Code 2016'
...
def part_one(args, input_lines):
    ...
    solver = doors.Doors(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = doors.Doors(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # RDULRDDRRD
    else:
        result = part_two(args, input_text)  # 752
