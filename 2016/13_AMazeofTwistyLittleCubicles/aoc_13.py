...
#                           a o c _ 1 3 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 13"
...
def parse_command_line():
    ...
    desc = 'A Maze of Twisty Little Cubicles - Day 13 of Advent of Code 2016'
...
def part_one(args, input_lines):
    ...
    solver = cubicles.Cubicles(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = cubicles.Cubicles(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 92
    else:
        result = part_two(args, input_text)  # 1350
