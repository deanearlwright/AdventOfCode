...
#                           a o c _ 0 5 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 05"
...
def parse_command_line():
    ...
    desc = 'How About a Nice Game of Chess - Day 05 of Advent of Code 2016'
...
def part_one(args, input_lines):
    ...
    solver = doorpass.Doorpass(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = doorpass.Doorpass(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 2414bc77
    else:
        result = part_two(args, input_text)  # 437e60fc
