...
#                           a o c _ 0 6 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 06"
...
def parse_command_line():
    ...
    desc = 'Signals and Noise - Day 06 of Advent of Code 2016'
...
def part_one(args, input_lines):
    ...
    solver = message.Message(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # agmwzecr
    else:
        result = part_two(args, input_text)  # owlaxqvq
