...
#                           a o c _ 1 8 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 18"
...
def parse_command_line():
    ...
    desc = 'Like a Rogue - Day 18 of Advent of Code 2016'
    sample = 'sample: python aoc_18.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = room.Room(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = room.Room(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 2016
    else:
        result = part_two(args, input_text)  # 19998750
