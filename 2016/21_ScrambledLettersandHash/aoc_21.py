...
#                           a o c _ 2 1 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 21"
...
def parse_command_line():
    ...
    desc = 'Scrambled Letters and Hash - Day 21 of Advent of Code 2016'
    sample = 'sample: python aoc_21.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = pword.Pword(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = pword.Pword(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # abcdefgh --> gcedfahb
    else:
        result = part_two(args, input_text)  # fbgdceah --> hegbdcfa
