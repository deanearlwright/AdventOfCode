...
#                           a o c _ 1 0 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 10"
...
def parse_command_line():
    ...
    desc = 'Balance Bots - Day 10 of Advent of Code 2016'
...
def part_one(args, input_lines):
    ...
    solver = bots.Bots(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = bots.Bots(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 56
    else:
        result = part_two(args, input_text)  # 7847
