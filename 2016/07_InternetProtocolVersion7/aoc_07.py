...
#                           a o c _ 0 7 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 07"
...
def parse_command_line():
    ...
    desc = 'Internet Protocol Version 7 - Day 07 of Advent of Code 2016'
...
def part_one(args, input_lines):
    ...
    solver = ip7list.Ip7list(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = ip7list.Ip7list(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 118
    else:
        result = part_two(args, input_text)  # 260
