...
#                           a o c _ 0 8 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 08"
...
def parse_command_line():
    ...
    desc = 'Two-Factor Authentication - Day 08 of Advent of Code 2016'
...
def part_one(args, input_lines):
    ...
    solver = display.Display(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = display.Display(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 128
    else:
        result = part_two(args, input_text)  # EOARGPHYAO
