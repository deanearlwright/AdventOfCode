...
#                           a o c _ 2 2 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 22"
...
def parse_command_line():
    ...
    desc = 'Grid Computing - Day 22 of Advent of Code 2016'
    sample = 'sample: python aoc_22.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = grid.Grid(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = grid.Grid(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 976
    else:
        result = part_two(args, input_text)  # 209
