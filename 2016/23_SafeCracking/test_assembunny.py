...
# ======================================================================
"Test solver for Advent of Code 2016 day 23, Safe Cracking"
...
class TestAssembunny(unittest.TestCase):  # pylint: disable=R0904
    ...
    def test_part_one(self):
        ...
        # 1. Create Assembunny object from text
        myobj = assembunny.Assembunny(text=aoc_23.from_text(PART_ONE_TEXT))
    ...
    def test_part_two(self):
        ...
        # 1. Create Assembunny object from text
        myobj = assembunny.Assembunny(part2=True, text=aoc_23.from_text(PART_TWO_TEXT))
