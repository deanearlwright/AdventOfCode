...
#                           a o c _ 0 1 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 01"
...
def parse_command_line():
    ...
    desc = 'No Time for a Taxicab - Day 01 of Advent of Code 2016'
...
def part_one(args, input_lines):
    ...
    solver = taxicab.Taxicab(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 291
    else:
        result = part_two(args, input_text)  # 159
