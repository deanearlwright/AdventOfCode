...
#                           a o c _ 1 4 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 14"
...
def parse_command_line():
    ...
    desc = 'One-Time Pad - Day 14 of Advent of Code 2016'
...
def part_one(args, input_lines):
    ...
    solver = pad.Pad(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = pad.Pad(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 23769
    else:
        result = part_two(args, input_text)  # 20606
