...
#                           a o c _ 2 5 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 25"
...
def parse_command_line():
    ...
    desc = 'Clock Signal - Day 25 of Advent of Code 2016'
    sample = 'sample: python aoc_25.py input.txt'
...
def part_one(args, input_lines):
    ...
    solver = assembunny.Assembunny(part2=False, text=input_lines)
...
def part_two(args, input_lines):
    ...
    # 1. Create the puzzle solver
    solver = assembunny.Assembunny(part2=True, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 180
    else:
        result = part_two(args, input_text)  # Merry Christmas
