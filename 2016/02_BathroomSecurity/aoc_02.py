...
#                           a o c _ 0 2 . p y
# ======================================================================
"Solve the puzzles for Advent of Code 2016 day 02"
...
def parse_command_line():
    ...
    desc = 'Bathroom Security - Day 02 of Advent of Code 2016'
...
def part_one(args, input_lines):
    ...
    solver = keypad.Keypad(part2=False, text=input_lines)
...
def main():
    ...
    if args.part == 1:
        result = part_one(args, input_text)  # 99332
    else:
        result = part_two(args, input_text)  # DD483
