...
//                             a o c _ 0 2 . t s
//
// Solve the Advent of Code 2016 day 02 problem
// ======================================================================
...
function parseCommandLine(): aocArguments {
  ...
  const { argv } = yargs
    .command('aoc_02', 'Bathroom Security - Day 02 of Advent of Code 2016', { })
    .option('verbose', {
      alias: 'v',
      default: false,
...
function partOne(args: aocArguments, inputLines: string[]): boolean {
  ...
  const solver = new Keypad(inputLines, false);
...
function partTwo(args: aocArguments, inputLines: string[]): boolean {
  ...
  // 1. Create the puzzle solver
  const solver = new Keypad(inputLines, true);
